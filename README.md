...
V2.18: Fixes stale/blank published snapshots causing Predictions to show as blank. Published caches now use v218 and first-load ignores unusable old blank payloads.
